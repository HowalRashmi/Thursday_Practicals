...
public class Person {
	...
	{
		Scanner sc= new Scanner(System.in);      //creating another scanner object
		...
		else if(i==3)            //calling parameterized constructor
		{
			Scanner s=new Scanner(System.in);
		...
		else if(i==4)            //calling parameterized constructor
		{
			Scanner s=new Scanner(System.in);
		...
		else if(i==5)                 //calling parameterized constructor
		{ 
			Scanner s=new Scanner(System.in);
		...
		else if(i==6)              //calling parameterized constructor
		{
			Scanner s=new Scanner(System.in);
		...
		else if(i==7)                  //calling no-argument constructor
		{
			Person p7= new Person();
		}
		else                    //when input is different from the choices provided
		{
